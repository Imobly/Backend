...
from app.schemas.payment import Payment, PaymentCreate, PaymentUpdate, PaymentBulkCreate
...
class payment_controller:
    ...
    def create_payment(self, db: Session, payment_data: PaymentCreate) -> Payment:
        """Criar novo pagamento"""
        return self.repository.create(db, obj_in=payment_data)
    
    def create_bulk_payments(self, db: Session, bulk_data: PaymentBulkCreate) -> List[Payment]:

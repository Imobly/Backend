...
from app.tenants.repository import tenant_repository
...
class tenant_controller:
    ...
    def get_tenant_by_email(self, db: Session, email: str) -> Tenant:
    ...
    def get_tenant_by_cpf(self, db: Session, cpf: str) -> Tenant:
